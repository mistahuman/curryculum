...
<div class="space-y-3">
	{#each cvStore.data.certifications as _cert, i (i)}
		<div
			class="overflow-hidden card border border-surface-200-800 preset-filled-surface-100-900 p-0"
		>
			<div class="flex items-end gap-4 p-4">
				...
				<button
					class="mb-0.5 btn-icon shrink-0 hover:preset-tonal-error"
