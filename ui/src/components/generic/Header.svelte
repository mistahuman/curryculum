<script lang="ts">
  ...
  const coreLinks = [{ href: `${base}/`, label: 'home', target: '_self' }];
</script>
...
>
  ...
  >
    ...
    <div class="flex items-stretch justify-start gap-4">
      ...
      <!-- Logo -->
      <a class="hidden xl:inline-block" href="{base}/" title="Mistahuman">
    ...
    <div class="flex justify-end items-stretch gap-2">
      ...
      <nav class="flex items-center gap-1">
        <a class="btn-icon hover:preset-tonal" href="https://github.com/mistahuman">
          <Github size={20} />
        </a>
      </nav>
    </div>
