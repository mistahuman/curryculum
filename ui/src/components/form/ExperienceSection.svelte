    ...
    >
      ...
      <article class="p-4 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="label">
            ...
            <div class="flex items-center gap-3">
              ...
              />
              <label class="flex items-center gap-1.5 cursor-pointer text-sm whitespace-nowrap">
                <input
                  type="checkbox"
        ...
        <div class="space-y-2">
          ...
          {/each}
          <button class="btn preset-tonal w-full text-sm" onclick={() => addAchievement(i)}>
