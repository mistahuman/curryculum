...
<div class="space-y-8">
  ...
  <section class="space-y-3">
    <p class="text-xs font-bold uppercase tracking-widest opacity-50">Technical Skills</p>
    <hr class="divider" />

    {#each s.tech_skills as skill, i}
      <div
        class="flex items-center gap-3 p-3 rounded-container bg-surface-100-900 border border-surface-200-800"
      >
        <input
  ...
  <!-- ── Soft Skills ───────────────────────────────────── -->
  <section class="space-y-3">
    <p class="text-xs font-bold uppercase tracking-widest opacity-50">Soft Skills</p>
    <hr class="divider" />

    {#each s.soft_skills as _, i}
  ...
  <!-- ── Languages ────────────────────────────────────── -->
  <section class="space-y-3">
    <p class="text-xs font-bold uppercase tracking-widest opacity-50">Languages</p>
    <hr class="divider" />

    {#each s.lang_skills as lang, i}
      <div
      ...
      >
        ...
        <article class="p-4 grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <label class="label" for="lang-{i}-overall">
            ...
            >
              <option value="">—</option>
              {#each CEF_LEVELS as l}<option value={l}>{l}</option>{/each}
            </select>
          </label>
  ...
  <!-- ── Driving License ──────────────────────────────── -->
  <section class="space-y-3">
    <p class="text-xs font-bold uppercase tracking-widest opacity-50">Driving License</p>
    <hr class="divider" />

    {#each s.driving_skills as _, i}
      <div class="flex gap-2 items-center">
        <input
          class="input flex-1"
          type="text"
